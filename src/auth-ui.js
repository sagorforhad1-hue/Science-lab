...
async function acceptCloud(result){
 ...
 authMode='login';authMessage='';session={role:liveProfile.role,id:liveProfile.id,teacherId:liveProfile.teacherId,accountId:liveProfile.id,demo:false};
